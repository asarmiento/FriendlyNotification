...
<body>
    <div id="app">
        ...
        <main class="" style="min-height: 870px">
        ...
        <footer class="card-footer " style="min-height: 60px; width: 100%; background-color: #1d293b; color: #f2f2f2; text-align: center; padding: 12px 0 12px 0">
